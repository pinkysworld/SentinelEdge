...
impl ForensicBundle {
    ...
    pub fn read_encrypted(path: &Path, key: &[u8; 32]) -> Result<String, String> {
        let data = fs::read(path).map_err(|e| format!("failed to read encrypted bundle: {e}"))?;
        if data.len() < 12 {
    ...
    pub fn linux() -> Self {
        Self {
            ...
            artifacts: vec![
                ...
                EvidenceArtifact {
                    name: "network_connections6",
                    path: "/proc/net/tcp6",
                    description: "Active IPv6 TCP connections",
                    volatile: true,
                },
                EvidenceArtifact {
                    name: "loaded_modules",
                ...
                EvidenceArtifact {
                    ...
                    description: "Custom systemd services",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "passwd",
                ...
                EvidenceArtifact {
                    name: "ssh_keys",
                    path: "/home/*/.ssh",
                    description: "SSH authorised keys",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "bash_history",
        ...
        Self {
            ...
            artifacts: vec![
                ...
                EvidenceArtifact {
                    name: "network_connections",
                    path: "/dev/null",
                    description: "Active connections (netstat -an)",
                    volatile: true,
                },
                EvidenceArtifact {
                    name: "unified_log",
                    path: "/var/db/diagnostics",
                    description: "macOS unified log",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "install_log",
                    path: "/var/log/install.log",
                    description: "Install history",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "launch_daemons",
                ...
                EvidenceArtifact {
                    name: "login_items",
                    path: "~/Library/Application Support/com.apple.backgroundtaskmanagementagent",
                ...
                EvidenceArtifact {
                    ...
                    description: "MDM configuration profiles",
                    volatile: false,
                },
                EvidenceArtifact {
                ...
                EvidenceArtifact {
                    ...
                    description: "System extensions (ESF)",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "quarantine_db",
        ...
        Self {
            ...
            artifacts: vec![
                EvidenceArtifact {
                    name: "process_list",
                    path: "NUL",
                    description: "Running processes (tasklist /v)",
                    volatile: true,
                },
                EvidenceArtifact {
                    name: "network_connections",
                    path: "NUL",
                    description: "Active connections (netstat -ano)",
                    volatile: true,
                },
                EvidenceArtifact {
                    name: "security_evtx",
                ...
                EvidenceArtifact {
                    ...
                    description: "ShimCache in SYSTEM hive",
                    volatile: false,
                },
                EvidenceArtifact {
                ...
                EvidenceArtifact {
                    name: "wmi_subscriptions",
                    path: r"C:\Windows\System32\wbem\Repository",
                ...
                EvidenceArtifact {
                    name: "ntuser_dat",
                    path: r"C:\Users\*\NTUSER.DAT",
                    description: "User registry hives",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "recent_files",
                    path: r"C:\Users\*\AppData\Roaming\Microsoft\Windows\Recent",
                    description: "Recently opened files",
                    volatile: false,
                },
                EvidenceArtifact {
                    name: "powershell_history",
                    path: r"C:\Users\*\AppData\Roaming\Microsoft\Windows\PowerShell\PSReadLine\ConsoleHost_history.txt",
                    description: "PS history",
                    volatile: false,
                },
            ],
        }
