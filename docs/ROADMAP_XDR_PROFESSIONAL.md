...
| Metric | Current (`v1.0.29`) | Target |
|---|---|---|
| Automated tests | 1827 Rust test functions + focused browser/admin regressions | maintained and expanded on every release |
