...
Recent 0.53.2 additions reflected in the generated SDKs include detection feedback and explainability responses, onboarding-readiness and manager queue-digest models, threat-intel `v2` library and sightings endpoints, deep malware scan `v2` profiles, and execution-context-aware reporting endpoints for reports, runs, schedules, and templates.
