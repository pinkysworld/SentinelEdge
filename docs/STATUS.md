...
- Rust project scaffold and runnable CLI (`demo`, `analyze`, `status`, `status-json`, `report`, `init-config`, `harness`, `export-model`, `serve`, `help`)
...
- 125 automated tests (105 unit + 20 integration) covering all modules
