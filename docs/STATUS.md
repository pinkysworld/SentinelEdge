...
- Rust project scaffold and runnable CLI (`demo`, `analyze`, `status`, `status-json`, `report`, `init-config`, `harness`, `export-model`, `attest`, `serve`, `help`)
...
- 140 automated tests (119 unit + 21 integration) covering all modules
